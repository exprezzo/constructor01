...
class conceptos_cotizacion extends Controlador{
	var $modelo="concepto_cotizacion";	
	
	
		function buscarConcepto(){
			$conceptoMod= new conceptoModelo();
			$res = $conceptoMod->buscar( array() );
		...
		function buscarCotizacion(){
			$cotizacionMod= new cotizacionModelo();
			$res = $cotizacionMod->buscar( array() );
			echo json_encode( $res );
		}
