...
var PaginasDeAutor=function (){	
	...
	this.init=function(config){
		...
		var me = this;
		$(this.tabId + "-dialog-confirm-eliminar-pagina").wijdialog({
			autoOpen: false,
            captionButtons: {                  
				pin: { visible: false },
	...
	this.configurarGrid=function(targetSelector, articulos){		
		...
		gridElementos.bind('keydown', function(e) {
			...
			if(e.keyCode==46 && e.shiftKey){
				...
				$(me.tabId + "-dialog-confirm-eliminar-pagina").wijdialog('open');
			}
		});
